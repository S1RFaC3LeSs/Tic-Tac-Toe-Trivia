...
const questions = [
    ...
    { question: "Who can file a Formal Complaint that may lead to Disciplinary Action?", options: ["A) Only a person directly involved can file", "B) A third-party if you are a witness", "C) If you're associated with the victim", "D) Anyone who hears about the complaint"], correct: "A" },
